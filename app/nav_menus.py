...
STATIC_CATALOG = [
    ...
    {"id": "sessions", "label": "Sessions", "icon": "📓", "href": "/sessions", "gm_only": True, "player_section": "sessions"},
    {"id": "facts", "label": "Facts", "icon": "🗒", "href": "/facts", "gm_only": True, "player_section": "facts"},
    ...
    {"id": "dreamlands", "label": "Dreamlands", "icon": "🌙", "href": "/dreamlands",
     "exact": True, "condition": "dreamlands_enabled", "gm_only": True, "player_section": "dreamlands"},
    ...
    {"id": "chronicler", "label": "Chronicler", "icon": "📜", "href": "/chronicler", "exact": True, "gm_only": False, "player_section": "chronicler"},
    {"id": "dice", "label": "Dice", "icon": "🎲", "href": "/dice", "exact": True, "gm_only": False, "player_section": "dice"},
    {"id": "session_log", "label": "Session Log", "icon": "📓", "href": "/session-log", "gm_only": False, "player_section": "session_log"},
    {"id": "rules", "label": "Rules", "icon": "📖", "href": "/rules", "exact": True, "gm_only": False, "player_section": "rules"},
    {"id": "characters", "label": "Player Characters", "icon": "🎲", "href": "/characters", "gm_only": False, "player_section": "characters"},
    {"id": "audio", "label": "Audio", "icon": "🎵", "href": "/audio", "exact": True, "gm_only": False, "player_section": "audio"},
    {"id": "video", "label": "Video", "icon": "🎬", "href": "/video", "exact": True, "gm_only": False, "player_section": "video"},
    {"id": "pages", "label": "Pages", "icon": "📄", "href": "/pages", "exact": True, "gm_only": False, "player_section": "pages"},
    ...
    kind_items = [
        {
            ...
            "ql_type": "kind", "ql_ref": k, "player_section": f"kind_{k}",
        }
        for k in kinds
    ]
