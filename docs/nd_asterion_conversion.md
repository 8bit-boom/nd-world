...
**Asterion** engine (see `asterion_rules.md` for the full, unmodified base rules —
dice pools, combat, Spark Shield/Flesh/Ichor, Glory, Domain Reclamation, items and
crafting, enemies, Reputation, Followers). None of that changes here. This document
covers **only** what's different: how a Neon & Dragons character is built.
...
**What changes:** instead of granting a fixed mechanical bonus, each pick becomes a
*seed* for a player-invented Asterion ability, built from Asterion's own Tier 1/2/3
property tables (see `asterion_rules.md` → "Ability Construction"). This keeps N&D's
identity and flavor completely intact while replacing its fixed bonuses with
Asterion's simpler, more flexible engine.
...
|---|---|---|---|
| **Race** (17, tiered Standard/Advanced/Exceptional) | Origin/Lineage-equivalent | Tier 1 | Mostly Passive — Armor, Resistance, Movement, Senses, Spark Shield |
...
- **Profession ability — Data Spider** (Tier 1 Active, Special Effect, 0 Ichor):
...
- **Background ability — Reputation Precedes You** (Tier 1 Active, Special Effect,
  0 Ichor): minor narrative effect — your bounty-fueled infamy alone cows or
  impresses a minor NPC once per scene, no roll needed.
- **Major Edge — Veil of the Unseen War** (Tier 3 Active, once per session, 3
  Ichor): properties — Special Effect (Hard Crowd Control: retroactively reveal
...
innate trait, then map it onto one Asterion Passive property (Spark Shield / Armor /
Resistance / Movement / Senses) at Tier 1. A few races (noted below) have a
...
| **High Elves/Elves** | Aura Sight | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — as an action, read a person's emotional/social aura for insight into their mood or intent. |
| **Human** | Adaptive Instinct | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — once per scene, briefly mimic a minor trick you've seen another race or profession use, at GM's discretion. |
...
| **Child of the Black Goat** | Voice of the Wild | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — telepathically communicate with nearby animals, who default to neutral or friendly toward you. |
...
| **Devilspawn** | Third Eye | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — open your third eye as an action to sense one hidden truth or danger nearby. |
...
| Race | Ability | Type & Tier | Effect |
|---|---|---|---|
| **Consumed by Yellow** | Hollow Vessel | Passive T1 (Spark Shield) | +1 Max Spark Shield, representing the Yellow's corrupted protection. *Flavor note: carries the race's own built-in hunger drawback — no formal Trade-Off needed, it's already baked into the fiction (must "feed" periodically or take Flesh damage). This race gets no race-Major-Edge — take your Major Edge from your Profession instead.* |
...
| **Stitches** | Undying Patchwork | Active T1 (Restoration, 0 Ichor) | Restore 1 Flesh, usable only the instant you would otherwise be Shattered — your body claws itself back together at the last second. |
...
ability (0 Ichor, one property from the Active table). Pick the resource's
signature, lowest-cost use as the concrete Tier 1 spec.

| Profession | Ability | Type & Tier | Effect |
|---|---|---|---|
| **Charlatan** | Grease Palms | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — talk or bribe your way past one minor obstacle (a locked door, a suspicious guard) without a roll. |
| **Cyberdoc** | Micro-Repair Cloud | Active T1 (Restoration, 0 Ichor) | Restore 1 Flesh to an ally at touch range with a burst of nanites. |
| **Hacker** | Data Spider | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — your Electronic Buddy digs up one usable lead about a target, system, or location. |
| **Merc** | Snapshot | Active T1 (Base Damage) | 1 Damage, melee/touch range — a fast, professional shot. |
| **Psyonic** | Call to Minds | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — briefly reach another psyonic you know mentally to send a short message or image. |
| **Street Fighter** | Trained Strike | Active T1 (Base Damage) | 1 Damage, melee — a precise unarmed or improvised strike. |
...
|---|---|---|---|
| **Ex-Corp** | Corporate Rolodex | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — call in a small corporate favor or contact once per scene (a name, a badge, a door that opens). |
...
| **Infamous** | Reputation Precedes You | Active T1 (Special Effect, 0 Ichor) | Minor narrative effect — your bounty-fueled infamy alone cows or impresses a minor NPC once per scene, no roll needed. |
| **Infected** | Undying Infection | Passive T1 (Spark Shield) | +1 Max Spark Shield — the necrotic virus keeps you standing. |
...
required three properties. All are **Active, once per session** (3 Ichor) per the
rule above — the GM adjudicates which specific narrative option applies each time
it's used, exactly as N&D's own Edge text already presents a menu of outcomes. The
